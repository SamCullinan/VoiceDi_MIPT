...
sys.path.insert(1, os.path.join(project_dir, 'decomposition'))
...
class IEMOCAP(data.Dataset):
    ...
    def __init__(self, selected_emos, mode, meta=None):
        ...
        if meta is None:
            self.meta = pd.read_csv(os.path.join(project_dir, 'decomposition/assets/iemocap_meta.csv'))
    ...
    def preprocess(self):
        ...
        # if meta is None:
        #     meta = pd.read_csv('/vol/bitbucket/apg416/decomposition/assets/iemocap_meta.csv')
